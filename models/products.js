...
export function create(product) {
    return db_conn.query(
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?)
    `,
        [product.name, product.stock, product.price, product.description, product.brand, product.type, product.staff_id_updated_by]
    );
}
...
export function update(product) {
    return db_conn.query(
        `
        UPDATE products
        SET product_name = ?, product_stock = ?, product_price = ?, product_description = ?, product_brand = ?, product_type = ?,  last_updated_by_staff_id = ?
        WHERE product_id = ?
    `,
        [product.name, product.stock, product.price, product.description, product.brand, product.type, product.staff_id_updated_by, product.id]
    );
}
